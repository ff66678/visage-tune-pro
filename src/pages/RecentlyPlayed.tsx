  ...
  return (
    <div className="min-h-screen bg-background">
      <nav className="flex items-center gap-3 px-4 pt-12 pb-4 sticky top-0 bg-background/85 backdrop-blur-xl z-40">
        ...
        <h1 className="text-lg font-semibold">最近播放</h1>
      </nav>
      ...
      <div className="px-6 pb-8">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-muted-foreground text-sm">还没有播放记录</p>
            <p className="text-muted-foreground/60 text-xs mt-1">完成训练后会在这里显示</p>
          </div>
        ) : (
