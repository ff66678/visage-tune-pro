      ...
      <div className="w-full max-w-[480px] min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar pb-6">
          ...
          <div
            ...
            style={{ height: "280px", borderBottomLeftRadius: "40px", borderBottomRightRadius: "40px" }}
          >
            ...
            <div className="absolute bottom-5 left-0 w-full px-6 z-20 text-center">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold mb-2 shadow-sm bg-card/80 backdrop-blur-sm text-primary">
          ...
          <div className="px-5 mt-5">
            {/* Yearly Plan */}
            <div
              className={`relative rounded-3xl p-5 cursor-pointer mb-3 transition-all active:scale-[0.98] bg-card border-2 ${selectedPlan === "yearly" ? "border-primary" : "border-border opacity-70"}`}
