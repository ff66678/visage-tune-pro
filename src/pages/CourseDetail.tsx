...
const CourseDetail = () => {
  ...
  return (
    <SwipeBack className={`min-h-screen bg-background flex flex-col relative overflow-hidden ${shouldAnimate ? 'animate-slide-in-right' : ''}`}>
      {createPortal(
        <div className="fixed top-0 left-0 w-full px-6 pb-3 pt-[max(3rem,env(safe-area-inset-top))] flex justify-between items-center z-20 bg-gradient-to-b from-black/40 to-transparent">
